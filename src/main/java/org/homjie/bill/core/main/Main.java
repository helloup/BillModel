...
public class Main {
	...
	public static void main(String[] args) {
		...
		Item item5 = new Item(new BigDecimal("12"), new BigDecimal("4")); // 8 += 133.01
		...
		charge4.addCharge(charge1).addCharge(charge2).settle(SettleCharge.NONE);
		charge5.addCharge(charge3).addCharge(charge4);		
